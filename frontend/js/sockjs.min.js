/* sockjs-client v1.3.0 | http://sockjs.org | MIT license */ ! function (e) {
        ...
        15: [function (e, t, n) {
            ...
            2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || 1 < ".".split(/()()/).length ? (_ = void 0 === /()??/.exec("")[1], s.split = function (e, t) {
                ...
                for (e = new RegExp(e.source, l + "g"), n += "", _ || (r = new RegExp("^" + e.source + "$(?!\\s)", l)), t = void 0 === t ? -1 >>> 0 : t >>> 0;
                    (o = e.exec(n)) && !(c < (i = o.index + o[0].length) && (a.push(n.slice(c, o.index)), !_ && 1 < o.length && o[0].replace(r, function () {
            ...
            (function (f) {
                ...
                p.exports = {
                    ...
                    createIframe: function (e, t) {
                        var n, r, o = f.document.createElement("iframe"),
                            i = function () {
                    ...
                    createHtmlfile: function (e, t) {
                        var n, r, o, i = ["Active"].concat("Object").join("X"),
                            s = new f[i]("htmlfile"),
                            a = function () {
        ...
        55: [function (e, a, l) {
            (function (s) {
                (function () {
                    ...
                    function W(e, l) {
                        ...
                        if (!d("json")) {
                            ...
                            if ((j = i.hasOwnProperty) || (j = function (e) {
                                    var n, t = {};
                                    return j = (t.__proto__ = null, t.__proto__ = {
                                        "toString": 1
                                ...
                                var v = {
                                    ...
                                    R = function (e, t, n, r, o, i, s) {
                                        ...
                                        if ("object" == typeof a && a)
                                            if ("[object Date]" != (l = O.call(a)) || j.call(a, "toJSON")) "function" == typeof a.toJSON && (l != C && l != N && l != A || j.call(a, "toJSON")) && (a = a.toJSON(e));
                                            else if (-1 / 0 < a && a < 1 / 0) {
                                            if (I) {
                                ...
                                var m, b, y = u.fromCharCode,
                                    ...
                                    _ = function (e) {
                                        ...
                                        if ("$" == e && w(), "string" == typeof e) {
                                            ...
                                            if ("[" == e) {
                                                for (t = [];
                                                    "]" != (e = x()); n || (n = !0)) n && ("," == e ? "]" == (e = x()) && w() : w()), "," == e && w(), t.push(_(e));
                                                return t
                                            }
                                            if ("{" == e) {
                                                for (t = {};
                                                    "}" != (e = x()); n || (n = !0)) n && ("," == e ? "}" == (e = x()) && w() : w()), "," != e && "string" == typeof e && "@" == (a ? e.charAt(0) : e[0]) && ":" == x() || w(), t[e.slice(1)] = _(x());
                                                return t
                                            }
                                            w()
                                        }
                    ...
                    if (!t || t.global !== t && t.window !== t && t.self !== t || (D = t), e) W(D, e);
                    else {
                        var n = D.JSON,
                            r = D.JSON3,
                            o = !1,
